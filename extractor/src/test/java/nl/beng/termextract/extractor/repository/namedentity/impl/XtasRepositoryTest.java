...
public class XtasRepositoryTest {
	...
	public void testExtract() {
		try {
			List<NamedEntity> namedEntities = xtasRepository.extract("Mooie goal van Ruud van Nistelrooy. 1-0 voor Manchester United. John Jones Mary and Mr. J. J. Jones ran to Washington.");
